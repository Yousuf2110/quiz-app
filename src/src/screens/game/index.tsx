...
const Game = () => {
  ...
  // Get the selected level from route params
  ...
  const normalQuestions = [
    ...
    },
    {
      id: 2,
      question:
        'Who is the author of the famous book "A Brief History of Time"?',
      options: [
        'Albert Einstein',
        'Isaac Newton',
        'Stephen Hawking',
    ...
    },
    {
      id: 34,
      question:
        'What is the main ingredient of traditional Japanese miso soup?',
  ...
  // Select questions based on the level
  let questions = [];
  if (level === 'easy') {
